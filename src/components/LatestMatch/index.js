...
const LatestMatch = props => {
  ...
  return (
    <div className="LatestMatch-main-container">
      <h1 className="LatestMatch-main-heading"> Latest Match </h1>
      <div className="latest-match-card">
        <div className="latest-card">
          ...
          <div>
            <img src={competingTeamLogo} className="latest-match-image" alt={`latest match ${competingTeam}`} />
          </div>
        </div>
